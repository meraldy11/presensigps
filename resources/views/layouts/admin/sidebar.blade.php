<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
      ...
      <h1 class="navbar-brand navbar-brand-autodark mt-3" style="font-size: 35px;color:rgb(255, 255, 255);font-weight:bold">
        {{-- <a href=".">
          <img src="{{ asset('assets/img/logooo.png')}}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
        </a> --}}
        S o W a n
      </h1>
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle {{ request()->is(['karyawan','departemen','cuti']) ? 'show' : ''  }}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['karyawan','departemen']) ? 'true' : ''  }}" >
